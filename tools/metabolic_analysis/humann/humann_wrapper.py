...
def generate_humann_param_file(sconstruct_filepath, args, data_dir):
    ...
    if args.cog_extracted_data == 'true':
    ...
    if not os.path.exists(tmp_output_dir):
        os.makedir(tmp_output_dir)
    sconstruct_file.write("c_strDirOutput = \"" + data_dir + '/' + tmp_output_dir + "\"\n")
    ...
    if args.ko_abundance== 'true':
        sconstruct_file.write(" CProcessor( \"00\",\"01\",\"enz\",c_strProgHits2Enzymes,[c_strFileKOC, c_strFileGeneLs],[str( c_fOrg )] ),\n")
