...
generate_tools_yml(){
    ...
    echo "        galaxy_tools_tool_list_files: [ \"files/common_tool_list.yaml\", \"files/pretreatments_tool_list.yaml\", \"files/taxonomic_assignation_tool_list.yaml\", \"files/functional_assignation_tool_list.yaml\"]" >> $1 
