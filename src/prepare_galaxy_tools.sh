...
./src/prepare_galaxy_tools/prepare_concatenate_tools.sh \
    $galaxy_tool_dir \
    $tool_dir
...
./src/prepare_galaxy_tools/prepare_usearch_tools.sh \
    $galaxy_tool_dir \
    $tool_dir
...
./src/prepare_galaxy_tools/prepare_search_similarity_tools.sh \
    $galaxy_tool_dir \
    $tool_dir
...
./src/prepare_galaxy_tools/prepare_analyze_metabolism_tools.sh \
    $galaxy_tool_dir \
    $tool_dir \
    $db_dir
